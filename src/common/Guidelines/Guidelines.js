        ...
        <Fragment>
            <div className="guideline-container mr-5 my-10 p-10 relative">
                ...
                <ul className="small-text">
                    <li>COVID test/vaccination rules: In view of the surge in number of COVID-19 cases, random on-arrival testing will be done for travellers arriving from states where there has been a spurt in number for COVID-19 cases. Travellers will be allowed to exit after sample collection. Thermal screening will be done for all travellers upon arrival.</li>
                    <li>Quarantine rules: Travellers who are found positive will be quarantined at home or CCC/CHC/Hospital for 10 days. Constitutional and Govt. functionaries as well as their staff members are exempted from 7 days of home quarantine.</li>
                    <li>Pre-registration or e-pass rules: Download and update the Aarogya Setu app.</li>
                    <li>Check the detailed list of travel guidelines issued by Indian States and UTs here KNOW MORE</li>
                    <li>If you have arrived on any international flight and are taking a connecting domestic flight, please check the 'Travelling to India' tab HERE.</li>
                </ul>
                ...
                <ul className="small-text">
                    ...
                    <li>One hand bag up to 7 kgs and 55x35x25cm, is allowed per traveller as cabin baggage. Certain personal articles like a lady's purse, laptop bags, etc. can be carried additionally.</li>
                </ul>
